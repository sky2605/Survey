...
<p>
<label for="dealer_name<?php $template->the_instance(); ?>"><?php _e( 'Dealer Name', 'theme-my-login' ) ?></label>
<input type="text" name="dealer_name" id="dealer_name<?php $template->the_instance(); ?>" class="input" value="<?php $template->the_posted_value('dealer_name'); ?>" size="20" />
</p>
<p>
